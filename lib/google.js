...
/**
 * Next 60 days. GCAL_ID takes one calendar or a comma-separated list, so her
...
export async function calendar() {
  ...
  const now = new Date();
  // Far enough ahead that "Next up" can reach a birthday weeks away.
  const end = new Date(now.getTime() + 60 * 864e5);
